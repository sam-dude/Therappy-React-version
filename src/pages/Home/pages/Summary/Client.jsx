...
const Client = () => {
  ...
  return !!user.current.extraData?.therapist ? (
    <div
      style={{
        display: "flex",
          ...
          onClick={() => {
            alert({
              ...
              config: {
                ...
                body: (
                  <span>
                    Después de la sesión exploratoria con el terapeuta podrán
                    decidir continuar con futuras sesiones. <br />
                    <br />
                    Si deciden no continuar tendrás la oportunidad de agendar
                    otra sesión exploratoria gratuita con otro terapeuta
                  </span>
                ),
                buttonText: "OK",
              },
